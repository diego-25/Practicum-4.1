...
@section('title', 'Nuevo Objetivo Estratégico')

@section('content')
<div class="container py-4">

    <h1 class="h4 mb-4">Registrar nuevo objetivo estratégico</h1>
    ...
    <form method="POST" action="{{ route('objetivos.store') }}">
        ...
        <div class="form-group mb-3">
            ...
            <select id="tipo" name="tipo"
                ...
                <option value="ODS" @selected(old('tipo')=='ODS')>
                    ODS
                </option>
                <option value="PND" @selected(old('tipo')=='PND')>
        ...
        <div class="form-group mb-3">
            ...
            <input id="nombre" name="nombre" type="text" required value="{{ old('nombre') }}" class="form-control @error('nombre') is-invalid @enderror">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input id="vigencia_desde" name="vigencia_desde" type="date" value="{{ old('vigencia_desde') }}" class="form-control @error('vigencia_desde') is-invalid @enderror">
                @error('vigencia_desde') <small class="text-danger">{{ $message }}</small> @enderror
            </div>

            <div class="col-md-6 mt-3 mt-md-0">
                <label for="vigencia_hasta">Vigencia hasta</label>
                <input id="vigencia_hasta" name="vigencia_hasta" type="date" value="{{ old('vigencia_hasta') }}" class="form-control @error('vigencia_hasta') is-invalid @enderror">
