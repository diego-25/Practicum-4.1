...
@section('content')
    ...
    {{-- Formulario para la creación de entidades --}}
        ...
        <form action="{{ route('instituciones.update', $institucion) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <x-text-input id="nombre" name="nombre" type="text" class="mt-1 block w-full"
                          :value="old('nombre', $institucion->nombre)" required maxlength="255"/>
        </div>
        ...
        <div>
            ...
            <x-text-input id="siglas" name="siglas" type="text" class="mt-1 block w-1/2"
                          :value="old('siglas', $institucion->siglas)" maxlength="50"/>
        </div>
        ...
        <div>
            ...
            <x-text-input id="ruc" name="ruc" type="text" class="mt-1 block w-1/2"
                          :value="old('ruc', $institucion->ruc)" required maxlength="13"/>
        </div>
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="email" class="mt-1 block w-full"
                          :value="old('email', $institucion->email)"/>
        </div>
        ...
        <div>
            ...
            <x-text-input id="telefono" name="telefono" type="text" class="mt-1 block w-1/2"
                          :value="old('telefono', $institucion->telefono)" maxlength="20"/>
        </div>
        ...
        <div>
            ...
            <textarea id="direccion" name="direccion" rows="2"
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('direccion', $institucion->direccion) }}</textarea>
        </div>
        ...
        <div class="flex items-center">
            <input id="estado" name="estado" type="checkbox" value="1"
                   ...
                   {{ old('estado', $institucion->estado) ? 'checked' : '' }}>
